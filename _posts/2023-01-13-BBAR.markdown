...
There are a few fragmeny-based molecular generative models, thought the definition of fragments in those works is different from the building block in this work. Podda et al.[1](https://proceedings.mlr.press/v108/podda20a.html) proposed
